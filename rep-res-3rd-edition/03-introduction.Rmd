...
On Linux you will need to install the *RCurl* \citep{R-RCurl}\index{RCurl} and *XML*\index{XML} \citep{R-XML} packages separately. Use your Terminal\index{Terminal} to install these packages with the following code:
...
[^chapter1_1_1]: @rokem2018 [3-4] note that some disciplines, e.g. computing 
    ...
    opposite meaning from they way they are used in this book and many other
