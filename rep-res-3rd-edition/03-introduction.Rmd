...
-   **Cloud storage & versioning**: Git/GitHub that can store data, code, and presentation files, save previous versions of these files, and make this information widely available.
...
presentation documents. The final part (chapters \@ref(LatexChapter) and \@ref(MarkdownChapter)) covers how to create reproducible
