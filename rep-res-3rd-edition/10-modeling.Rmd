...
You can use any of the LaTeX font sizes listed Chapter \@ref(LatexChapter).
...
function; it looks like LaTeX, but is actually *knitr* syntax.[^chapter_8_4] Its structure
