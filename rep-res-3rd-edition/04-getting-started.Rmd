...
Markdown-created website with the LaTeX `includegraphics`\index{LaTeX command!include\_graphics} function or *knitr*'s `include_graphics()`\index{R function!include\_graphics}
