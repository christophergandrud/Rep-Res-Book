...
<http://r-pkgs.had.co.nz/intro.html#introduction-to-devtools>.
...
\@ref(NewProjectGit)). In the **New Project** window, select
...
research files publicly available. Regardless, cloud storage systems like
...
your results may change the results someone gets reproducing your research. This problem becomes larger as you use more pieces of software in your research.
...
recorded which versions they used. One approach is to use the *packrat* R package [@R-packrat] for managing the
...
[^chapter_14_1]: A good point of entry into the R reproducible research community
    is R-bloggers (<https://www.r-bloggers.com/>). The site aggregates
    ...
    (<https://stackoverflow.com/questions/tagged/r>) and Cross Validated
    (<https://stats.stackexchange.com/questions/tagged/r>) sites.

[^chapter_14_2]: See: <http://www.handle.net/>.

[^chapter_14_3]: <https://figshare.com/>

[^chapter_14_4]: <https://zenodo.org/>

[^chapter_14_5]: The Dataverse Project (<https://dataverse.org/>) offers a free
