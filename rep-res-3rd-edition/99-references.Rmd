...
pkg_additional <- c(
    .packages(),
    "animation", "bookdown", "countrycode", "data.table", "dplyr", "formatR", "ggplot2", "here", "htmlwidgets", "httr", "IRkernel", "jsonlite", "magick", "markdown", "packrat", "pacman", "pdftools", "ProjectTemplate", "RCurl", "rvest", "shiny", "stargazer", "styler", "survival", "tibble", "tidyr", "tinytex", "XML"
)
