...
pkg_additional <- c(
    .packages(),
    "animation", "bookdown", "countrycode", "data.table", "dplyr", "formatR",
    "ggplot2", "here", "htmlwidgets", "httr", "IRkernel", "jsonlite",
    "magick", "packrat", "pacman", "pdftools", "RCurl", "rvest",
    "stargazer", "styler", "survival", "tibble", "tidyr", "tinytex", "XML"
)
