...
```{r echo=FALSE, fig.cap='R Markdown Compile Dropdown Menu', fig.lb='Rmarkdrop', out.width='2cm', out.height='5cm'}
...
asterisks, e.g. `*Iitalicize these words*`. To make words **bold**, place
