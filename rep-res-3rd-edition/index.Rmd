...
-   Examples of Tidyverse tibbles in addition to standard data frames.

-   Examples with the easier `pivot_longer()` and `pivot_wider()` functions instead of the more awkward `gather()` and `spread()` functions for pivoting data frames.  

-   Naming conventions are in current R-Tidyverse best practice.

-   Cleaned up the 'link rot', i.e. dead URLs.

-   Removed technologies and techniques that are no longer widely used.

-   The book formatted using *bookdown* [@R-bookdown].
