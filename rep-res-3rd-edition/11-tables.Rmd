...
M1Table <- xtable(M1, caption = "Linear Regression, Dependent Variable: Exam Score",
                label = "BasicXtableSummary",
                digits = 1)
...
cleaning up (see the chapter's Appendix for more details) you can use
*NBSumdata frame* with *xtable* as before to create Table \@ref(CoefEstTable).
