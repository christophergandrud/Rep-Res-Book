...
<https://bit.ly/2FaMkOJ>.[^chapter_10_24] So to knit the graph like into a LaTeX document manually specifying the figure environment we type: \index{LaTeX environment!figure}
...
**l.95..CI** using the `reorder()` function.\index{R function!reorder} We renamed this column "lower" so that it would be easier to work with in `ggplot()`.\index{R function!ggplot2} Reordering by these values make the plot easier to
