...
- **Dropbox**'s version control system just lets you open old versions of your files. It also creates a new version every time you save a file, which can make it difficult to actually find the version you want. **git**'s version control system only creates a new version when you tell it to. It also, tracks every change you make in a way that makes it relatively easy to find the version you want. The **GitHub** website and GUI programs for Mac and Windows provide a nice interface for examining these changes.

- Ability to note and discuss issues you have while doing your research.
