...
**Dropbox** does a fine job of meeting our four basic criteria for reproducible data storage. **GitHub** meets these criteria and more. <!--- Remember to explain what GitHub is in an earlier chapter --->
...
**Dropbox**'s version control system just lets you open old versions of your files. **git**'s version control system actually track