...
In practice, it needs to be {\emph{easy}} for independent researchers to reproduce your research.\cite{Ball2012} In this book we will learn ways to make research easily reproducible. 
...
Replicability has been a key part of scientific enquiry since at leas the 1660s\cite{Stodden2010} when the Royal Society began publishing descriptions of experiments and even hosting demonstrations--replications--of experiments. Why is replication so important for scientific inquiry? 

\paragraph{Standard to Judge Scientific Claims} 
Science, according to the American Physical Society, ``is the systematic enterprise of gathering knowledge \ldots organizing and condensing that knowledge into testable laws and theories."\footnote{See \url{http://www.aps.org/policy/statements/99_6.cfm}.} The ``ultimate standard" for evaluating these scientific claim is whether or not the claim can be replicated.\cite{Peng2011} 

\paragraph{Error is a part of doing computational science}
...
Many authors have argued\cite{Peng2011} CITE OTHERS (and it's my personal experience researching in political science) that even if researchers know how to use the tools of reproducible research a major impediment to them actually doing so is a lack of infrastructure for making the reproducible research available. Hopefully this book will be useful for editors at academic publishers who want to be able to better evaluate reproducible research and develop systems for making it more widely available.
