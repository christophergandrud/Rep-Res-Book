...
\noindent In this book we will actually aim for replicable research, as new technologies actually make it possible to replicate a data set, especially if the data is available over the internet.
...
\begin{table}
    ...
    \vspace{0.3cm}
    \begin{tabular}{l c  p{6.5cm}  l{4cm}}
        \hline
        ...
        \texttt{![]()} & Markdown & Inserts a figure into a Markdown document. & \ref{MarkdownChapter} \\        
        \hline 
