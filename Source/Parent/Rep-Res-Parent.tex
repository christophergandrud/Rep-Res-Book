...
\hlcomment{# Display contents of StringNumObject}
StringNumObject
\end{alltt}
\begin{verbatim}
...
{\ttfamily\noindent\itshape\textcolor{messagecolor}{\#\# Find out what's changed in ggplot2 with\\\#\# news(Version == "0.9.1", package = "ggplot2")}}\end{kframe}
\end{knitrout}
...
RStudio is highly integrated with {\emph{knitr}}
