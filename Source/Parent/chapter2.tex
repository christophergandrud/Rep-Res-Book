...
##  [1] googleVis_0.3.3     RJSONIO_1.0-1       reshape_0.8.4      
##  [4] plyr_1.8            MCMCpack_1.2-4      coda_0.16-1        
##  [7] lattice_0.20-10     foreign_0.8-51      Zelig_3.5.5        
## [10] boot_1.3-7          MASS_7.3-22         xtable_1.7-0       
## [13] texreg_1.15         RCurl_1.95-3        bitops_1.0-4.2     
## [16] openair_0.7-0       markdown_0.5.3      knitcitations_0.1-0
## [19] bibtex_0.3-4        knitr_0.9           ggplot2_0.9.3      
## [22] extrafont_0.12      devtools_0.8        apsrtable_0.8-8    
## [25] slidify_0.3.3      
## 
## loaded via a namespace (and not attached):
##  [1] cluster_1.14.3     codetools_0.2-8    colorspace_1.2-0  
##  [4] dichromat_1.2-4    digest_0.6.0       evaluate_0.4.3    
...
## [22] reshape2_1.2.2     Rttf2pt1_1.1       scales_0.2.3      
## [25] stringr_0.6.2      whisker_0.3-2      XML_3.95-0.1      
## [28] yaml_2.1.5
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\hlcomment{# Updated 20 November 2012}
\hlcomment{##################}
\end{alltt}
\end{kframe}
\end{knitrout}
