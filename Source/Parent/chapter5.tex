...
R is also able to save data in a wide variety of other file formats, mostly through the {\emph{foreign}} package. These formats may be less future proof than simple text-formatted data files.
