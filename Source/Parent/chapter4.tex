...
There is also a \texttt{cat} shell command.\index{cat, shell command} It works slightly differently than the R version of the command and I don't cover it here.
