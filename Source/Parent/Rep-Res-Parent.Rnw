...
<<ChildStylisticConventions, echo=FALSE, messages=FALSE, results='hide'>>=
system("pandoc /git_repositories/Rep-Res-Book/Source/FrontMatter/StylisticConventions.md -t latex -o /git_repositories/Rep-Res-Book/Temp/StyleTemp.tex", intern = TRUE)
@
