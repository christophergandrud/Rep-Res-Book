...
If you are using a cloned GitHub repo you can push and pull them with the \texttt{Pull Branches} and \texttt{Push Branches} buttons in the \texttt{More} drop down menu.
