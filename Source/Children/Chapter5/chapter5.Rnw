...
Note: if you created your Dropbox account after 4 October 2012 you will not automatically have a \emph{Public} folder. To enable on on your account see this website: \url{https://www.dropbox.com/help/16/en}.\label{EnablePublicFolder}\index{Dropbox Public folder, enable}
