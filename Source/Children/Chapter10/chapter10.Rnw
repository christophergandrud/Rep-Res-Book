...
In this chapter we have learned how to take results from our statistical analyses and other information from our data and dynamically present them in figures using \emph{knitr}. In the next three chapters we will learn how to take the tables we created in Chapter \ref{TablesChapter} and the figures we created in this chapter and embed them in full LaTeX and Markdown presentation documents.
