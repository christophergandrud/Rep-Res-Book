...
\begin{itemize}
    ...
    \item Yihue Xie's \citeyearpar{Xie2013} book \textbf{Dynamic Documents with R and knitr} provides a comprehensive look at how to create documents with \emph{knitr}. It's a good complement to this book's generally more research project level approach. 
...
If you notice any errors or places where the book can be improved please report them on the book's GitHub Issues page: \url{https://github.com/christophergandrud/Rep-Res-Book/issues}.
