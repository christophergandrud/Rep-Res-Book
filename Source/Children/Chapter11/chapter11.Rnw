...
In Chapter \ref{MarkdownChapter} (page \pageref{rmarkdownBeamer}) we will see how to use the \emph{rmarkdown} package to create beamer presentations with the much simpler Markdown syntax.
