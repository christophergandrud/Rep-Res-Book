...
In this chapter we have learned the knitty-gritty of how to create simple LaTeX documents--articles and slideshows--that we can embed our reproducible research in using \emph{knitr}. In the next chapter we look at more complex LaTeX documents, including theses, books, and batch reports.
