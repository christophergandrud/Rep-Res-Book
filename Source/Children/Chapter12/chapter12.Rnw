...
As in the previous chapter, because we are looking at documents created directly in LaTeX most of the discussion in this chapter applies to \emph{knitr}, but not \emph{rmarkdown}.
