...
\noindent For more details see the \emph{slidify} website: \url{http://ramnathv.github.com/slidify/start.html#}. Use the same procedures to also install the \emph{repmis}\index{repmis} package \citep{R-repmis}.\label{repmisInstall}

<<FrontrepmisInstall, eval=FALSE>>=
