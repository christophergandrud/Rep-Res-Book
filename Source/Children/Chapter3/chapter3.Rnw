...
\begin{table}
  ...
  \begin{tabular}{l c p{5cm}}
    ...
    \texttt{include} & Logical & Whether to run the chunk, but don't echo the code or include the results. \\[0.25cm]
    \texttt{message} & Logical & Whether or not to include message messages. \\[0.25cm]
    \texttt{results} & Character & Whether and how to include results in the presentation document. \\[0.25cm]
