...
We've covered a lot of ground in this chapter, including R basics, how to use RStudio, and \emph{knitr} syntax for multiple markup languages. These tools, especially R and \emph{knitr}, are fundamental to the reproducible research process we will learn in this book. They enable us to create dynamic text-based files that record our research steps in detail. In the next chapter we will look at how to orginize files created with these types of tools into reproducible research projects. 
