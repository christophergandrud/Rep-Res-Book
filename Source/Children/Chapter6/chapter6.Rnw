...
<<Ch5ExampleMake, error=FALSE, message=FALSE, warning=FALSE>>=
# Example Make file
...
Data <- getURL(UrlAddress)

# Convert Data into a data frame
Data <- read.table(textConnection(Data), 
                    sep = ",", header = TRUE)
@
