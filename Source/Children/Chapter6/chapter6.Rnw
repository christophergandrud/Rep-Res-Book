...
<<Ch5ExampleMake, error=FALSE, eval=FALSE>>=
# Example Make file
...
# Note: Merged data given the object name CleanedData
source("GatherSource/MergeData.R)


# Save cleaned/merged Data as MainData.csv
write.table(CleandedData, 
            file = "/DataFiles/MainData.csv", 
            sep = ",")
@
...
<<Ch6CSV, eval=FALSE>>=
Data <- read.table(file = "~/Data1.csv", sep = ",")
@
