...
# Summarize the fertilizer consumption variable from FertConsumpData 
...
ggplot(data = MoltenFert, aes(FertilizerConsumption)) +
        ...
        theme_bw()
@
    {\scriptsize{Source: World Bank (2012). See the Chapter's Appendix for the source code to create this figure.}}
\end{figure} 
