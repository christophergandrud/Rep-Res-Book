...
After merging data frames it is always a good idea to look at the result and make it is what you expected. Some post merging clean up may be required to get the data frame ready for statistical analysis.
