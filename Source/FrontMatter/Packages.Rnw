...
Once you enter this code, you may be asked to select a ``mirror"\index{mirror, CRAN} to download the packages from. Simply select the mirror closest to you.

<<FrontPackageCitations, echo=FALSE, message=FALSE, warning=FALSE>>=
# Create package list
PackagesCited <- c("apsrtable", 
                    "devtools",
                    "formatR", 
                    "ggplot2", 
                    "knitr", 
