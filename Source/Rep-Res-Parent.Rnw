...
<<ChildFrontPackages, child=c('Children/FrontMatter/Packages.Rnw')>>=
@
...
<<Child4, child=c('Children/Chapter11/chapter11.Rnw', 'Children/Chapter12/chapter12.Rnw', 'Children/Chapter13/chapter13.Rnw', 'Children/ExampleProject/ExampleProject.Rnw', 'Children/Chapter14/chapter14.Rnw'), eval=TRUE, warning=FALSE>>=
@

% Include bibliotraphy
\clearpage
\bibliographystyle{apa}
\bibliography{rep-res-book.bib,rep-res-PackagesCited}
