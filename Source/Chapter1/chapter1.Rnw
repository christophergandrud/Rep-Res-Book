...
\textbf{R} and \textbf{RStudio}. It is designed to give you the
necessary tools to use this workflow for your own research. It is not
designed to be a complete introduction to \textbf{R}, \textbf{RStudio},
\textbf{GitHub}, the command line, or any other program that is a part
...
I cover in this book. While learning how to use \textbf{R} and the other
...
example, what the \texttt{\$} in \textbf{R} is used for. I hope to save
...
the nitty-gritty of \textbf{R} and the command line.

\begin{itemize}
\item
  Michael J. Crawley's encyclopaedic \textbf{R} book, appropriately
  titled, \textbf{The R Book} published by Wiley.
\item
  Norman Matloff's tour through the programming language aspects of
  \textbf{R} called \textbf{The Art of R Programming: A Tour of
...
\item
  ...
  running \textbf{PowerShell} (see Chapter 2) see William E. Shotts
  Jr.'s book \emph{The Linux Command Line: A Complete Introduction} also
  published by No Starch Press.
\item
  The \textbf{RStudio} website (\url{http://rstudio.org/docs/}) has a
...
\textbf{R} or \textbackslash{}( \LaTeX \textbackslash{}) may want to
skip over the nitty-gritty parts of the book that describe how to
manipulate data frames or compile a \textbackslash{}(
\LaTeX \textbackslash{}) document into a PDF. Please feel free to do
this.

If you are experienced with \textbf{R} in particular you may want to
skip over Chapter 3: Getting Started with \textbf{R}/\textbf{RStudio}.
