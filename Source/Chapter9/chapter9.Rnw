...
# Reorder variables and remove the standard error.
...
It may take a bit of hunting to find what you want, but a similar process can be used to create tables from objects of virtually any class. Hunting for what you want is generally easier by clicking on the object in {\bf{RStudio}}'s workspace pane.
